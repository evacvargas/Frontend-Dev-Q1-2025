class AuthorModal extends HTMLElement {
  constructor() {
    ...
    template.innerHTML = `
      ...
      <div class="hidden fixed inset-0 z-10 flex justify-center items-center bg-black bg-opacity-30 backdrop-blur-md" id="modal">
        <div class="flex flex-col gap-4 bg-white p-5 rounded max-w-md w-full rounded-lg">
